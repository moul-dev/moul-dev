...
- **System Telemetry:** Integrated Telegraf metrics collection directly into the server, exposing CPU, memory, and disk telemetry without running third-party monitoring daemons.
