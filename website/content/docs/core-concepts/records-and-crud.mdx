...
| `expand` | `string` | `""` | Comma-separated relation field names to expand inline. | `expand=authorId,categories` |
| `fields` | `string` | `*` | Comma-separated fields to return in the payload. | `fields=id,title,createdAt` |
