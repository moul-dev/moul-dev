...
- **Data Import & Export**: One-click CSV and JSON export modals (with schema envelope toggle) and drag-and-drop import modal with format auto-detection, conflict modes (`upsert`, `insert`, `replace`), and detailed error reporting.
