...
- `GET /api/analytics/summary` — Returns total visits, unique visitors, page views, and error rates.
- `GET /api/analytics/requests` — Paginated list of recent HTTP requests.
- `GET /api/system/metrics` — Live host CPU usage, RAM utilization, disk space, and active Go goroutines.
