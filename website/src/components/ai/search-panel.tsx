...
const ChatContext = createContext<UseChatHelpers<ChatUIMessage> | null>(null);

function useChatContext() {
  const chat = use(ChatContext);
  if (!chat) throw new Error("useChatContext must be used within ChatContext");
  return chat;
}
...
export function AISearchPanelContent() {
...
export default AISearchPanelContent;
